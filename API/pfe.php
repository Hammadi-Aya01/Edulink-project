...
<body>
  ...
  <div class="container">
    ...
    <!-- Formulaire d'ajout -->
    <div class="section">
      <h2>➕ Ajouter un projet PFE</h2>
      <form id="pfeForm" method="post" action="ajouterProjet.php">
        <input type="text" id="titrePfe" name="titre" placeholder="Titre du projet" required>
        <textarea id="descPfe" name="description" placeholder="Description du projet" rows="4" required></textarea>
    ...
    <div class="section">
      ...
      <div id="pfeList">
        ...
        $sql = "SELECT * FROM projet WHERE Type='PFE'";
  ...
  <script>
    ...
    const list = document.getElementById("pfeList");
    const messageDiv = document.getElementById("message");

    form.addEventListener("submit", function(e) {
      e.preventDefault();
      
      const titre = document.getElementById("titrePfe").value;
      const desc = document.getElementById("descPfe").value;
